...
auto main(int argc, char **argv) -> int {
  ...
  argparse::ArgumentParser program("vdbms-htable-bench");
  ...
  vdbms::DiskExtendibleHashTable<vdbms::GenericKey<8>, vdbms::RID, vdbms::GenericComparator<8>> index(
      "foo_pk", bpm.get(), comparator, vdbms::HashFunction<vdbms::GenericKey<8>>());
